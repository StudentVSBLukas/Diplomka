...
describe('BackjumpingService', () => {
  ...
  it('příklad "Backtracking" spočte během 80 kroků', () => {
    const postup = service.run(testUtils.backtrackingExample, 0);
  ...
  it('příklad "Random backtracking" spočte během 80 kroků', () => {
    const postup = service.run(testUtils.backtrackingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(80);
  });
  ...
  it('příklad "Backjumping" spočte během 80 kroků', () => {
    const postup = service.run(testUtils.backjumpingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(80);
  });
  ...
  it('příklad "Forward checking" spočte během 80 kroků', () => {
    const postup = service.run(testUtils.forwardCheckingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(80);
  });
