...
describe('ForwardCheckingDynamicOrderService', () => {
  ...
  it('příklad "Backtracking" spočte během 29 kroků', () => {
    const postup = service.run(testUtils.backtrackingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(29);
  });
  ...
  it('příklad "Random backtracking" spočte během 29 kroků', () => {
    const postup = service.run(testUtils.backtrackingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(29);
  });
  ...
  it('příklad "Forward checking" spočte během 29 kroků', () => {
    const postup = service.run(testUtils.forwardCheckingExample, 0);
    expect(testUtils.pocetUzlu(postup)).toBe(29);
  });
